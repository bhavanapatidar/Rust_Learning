// mutable reference allows you to change the value of the borrowed data.
...
fn main(){
    let mut user1 =  user{  // creating instance of struct and assigning values , we can also assign in any order
    ...
    user1.name = String::from("Ali Raza");
